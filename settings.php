...
//Tarik data email berdasarkan username
$query = $conn->prepare("SELECT email FROM user WHERE username = :username");
$query->bindParam(':username', $username); $query->execute(); //simpan hasil kedalam $email 
$result = $query->fetch(PDO::FETCH_ASSOC); $email =
$result['email']; } ?>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h1 class="modal-title fs-4" id="delete_user_label">
                          Delete Account?
                        </h1>
                        <button
                          type="button"
                      ...
                      <div class="modal-body">
                        Deleting your account will remove all your personal
                        information. This action is permanent and cannot be
                        undone.
                      </div>
